...
module.exports = async function handler(req, res) {
  ...
  function buildSystemInstruction(context) {
    return [
      ...
      '- Nunca peca para o usuario formatar a lista — voce mesmo ja formata',
      '- Se o usuario mencionar qualquer lista de contas, despesas ou dividas:',
      '  1. Formate VOCE MESMO cada item assim: "Nome – R$ valor – Nx – dia N"',
      '  2. Se nao souber parcelas, use 1x. Se nao souber o dia, use dia 10',
      '  3. Liste TODOS os itens formatados',
      '  4. Termine com: "Quer que eu adicione essas contas no seu painel agora? É só confirmar!"',
      '- NUNCA peca ao usuario para reformatar ou cole no formato X — faca voce mesmo',
      '',
      'DADOS DO USUARIO:',
