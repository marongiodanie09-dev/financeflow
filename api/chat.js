module.exports = async function handler(req, res) {
  ...
  try {
    ...
    var systemInstruction = 'Voce e o assistente financeiro do FinanceFlow, um app de controle financeiro pessoal.\n\n';
    systemInstruction += 'REGRAS:\n';
    systemInstruction += '- Responda SEMPRE em portugues do Brasil\n';
    systemInstruction += '- Seja direto, pratico e amigavel\n';
    systemInstruction += '- Use dados concretos do usuario para personalizar as respostas\n';
